#This R-script will clean the LST Day temperature data and separate it into separate years
...
day_lst <- rbind(tif_2019, tif_2020, tif_2021, tif_2022, tif_2023)

#Get rid of any instances of zero 
summary(day_lst$Temp)
day_lst <- day_lst %>%
  mutate(Temp = ifelse(Temp == 0, NA, Temp))

#Save the dataframe
saveRDS(day_lst, "/Volumes/Seagate Portable Drive/3.clean_data/MOD11A1_Daytime_Data.RDS")

# write.csv(tif_2019, "CleanedData/MOD11A1DayLST2019.csv")
# write.csv(tif_2020, "CleanedData/MOD11A1DayLST2020.csv")
# write.csv(tif_2021, "CleanedData/MOD11A1DayLST2021.csv")
# write.csv(tif_2022, "CleanedData/MOD11A1DayLST2022.csv")
# write.csv(tif_2023, "CleanedData/MOD11A1DayLST2023.csv")
