...
#Save the dataframe
saveRDS(day_lst, "/Volumes/Seagate Portable Drive/3.clean_data/MYD11A1_Daytime_Data.RDS")



# write.csv(tif_2019, "CleanedData/MYD11A1DayLST2019.csv")
# write.csv(tif_2020, "CleanedData/MYD11A1DayLST2020.csv")
# write.csv(tif_2021, "CleanedData/MYD11A1DayLST2021.csv")
# write.csv(tif_2022, "CleanedData/MYD11A1DayLST2022.csv")
# write.csv(tif_2023, "CleanedData/MYD11A1DayLST2023.csv")