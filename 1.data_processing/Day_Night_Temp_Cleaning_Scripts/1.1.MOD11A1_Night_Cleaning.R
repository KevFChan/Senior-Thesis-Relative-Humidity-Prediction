...
#Save the dataframe
saveRDS(night_lst, "/Volumes/Seagate Portable Drive/3.clean_data/MOD11A1_Nighttime_Data.RDS")

# write.csv(tif_2019, "CleanedData/MOD11A1NightLST2019.csv")
# write.csv(tif_2020, "CleanedData/MOD11A1NightLST2020.csv")
# write.csv(tif_2021, "CleanedData/MOD11A1NightLST2021.csv")
# write.csv(tif_2022, "CleanedData/MOD11A1NightLST2022.csv")
# write.csv(tif_2023, "CleanedData/MOD11A1NightLST2023.csv")
