...
The purpose of this Rmd file is to convert the MYD11A1 land surface temperature day raster data into a CSV file format.
...
```{r}
write.csv(tif_2019, "/Volumes/Seagate Portable Drive/0.raw_data/CleanedData/MYD11A1Day2019.csv")
write.csv(tif_2020, "/Volumes/Seagate Portable Drive/0.raw_data/CleanedData/MYD11A1Day2020.csv")
write.csv(tif_2021, "/Volumes/Seagate Portable Drive/0.raw_data/CleanedData/MYD11A1Day2021.csv")
write.csv(tif_2022, "/Volumes/Seagate Portable Drive/0.raw_data/CleanedData/MYD11A1Day2022.csv")
write.csv(tif_2023, "/Volumes/Seagate Portable Drive/0.raw_data/CleanedData/MYD11A1Day2023.csv")
```
