#This is a file to test out the ERA5 Data Cleaning for 2023 DewPoint
library(raster)
library(sf)
library(foreach)
library(doParallel)
...
string_dir <- paste0("/home/kfc27/project/ERAProcessingData/StepOneDPandTemp/ERA5Dewpoint/era5DewPoint_", date_string, ".csv")
