...
#CHANGE THESE TWO
eratemp <- readRDS("/home/kfc27/project/ERAProcessingData/StepTwoCleanedERAData/Temperature/temp_2022.RDS")
eradewpoint <- readRDS("/home/kfc27/project/ERAProcessingData/StepTwoCleanedERAData/Dewpoint/dp_2022.RDS")
...
#So we've fixed it
print("After changing the bounds")
print(summary(eramerged$RelativeHumidity))
...
saveRDS(RHera, "/home/kfc27/project/ERAProcessingData/StepTwoCleanedERAData/RelativeHumidity/eraRH2022.RDS")
