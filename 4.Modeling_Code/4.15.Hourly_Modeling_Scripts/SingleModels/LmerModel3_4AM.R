...
save(model1, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/LmerModels/lmeModel_3AM.Rdata")
save(model2, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/LmerModels/lmeModel_4AM.Rdata")
