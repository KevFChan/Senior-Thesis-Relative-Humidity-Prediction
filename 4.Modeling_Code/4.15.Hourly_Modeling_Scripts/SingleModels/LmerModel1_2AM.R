...
save(model1, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/LmerModels/lmeModel_1AM.Rdata")
save(model2, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/LmerModels/lmeModel_2AM.Rdata")
