#ERA Hourly Modeling for 3 and 4 AM
...
hour1 <- era_data[era_data$Hour == 3, ]
hour2 <- era_data[era_data$Hour == 4, ]
...
save(model1, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_3AM.Rdata")
save(model2, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_4AM.Rdata")
