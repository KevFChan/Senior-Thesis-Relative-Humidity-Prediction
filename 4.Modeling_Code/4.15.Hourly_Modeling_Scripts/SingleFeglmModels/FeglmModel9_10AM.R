#ERA Hourly Modeling for 9 and 10 AM
...
hour1 <- era_data[era_data$Hour == 9, ]
hour2 <- era_data[era_data$Hour == 10, ]
...
save(model1, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_9AM.Rdata")
save(model2, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_10AM.Rdata")
