#ERA Hourly Modeling for 11 AM and 12 PM
...
hour1 <- era_data[era_data$Hour == 11, ]
hour2 <- era_data[era_data$Hour == 12, ]
...
save(model1, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_11AM.Rdata")
save(model2, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_12PM.Rdata")
