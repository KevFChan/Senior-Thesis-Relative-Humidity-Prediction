#ERA Hourly Modeling for 7 and 8 AM
...
hour1 <- era_data[era_data$Hour == 7, ]
hour2 <- era_data[era_data$Hour == 8, ]
...
save(model1, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_7AM.Rdata")
save(model2, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_8AM.Rdata")
