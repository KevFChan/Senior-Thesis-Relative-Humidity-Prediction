#ERA Hourly Modeling for 3 PM and 4 PM
...
hour1 <- era_data[era_data$Hour == 15, ]
hour2 <- era_data[era_data$Hour == 16, ]
...
save(model1, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_3PM.Rdata")
save(model2, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_4PM.Rdata")
