#ERA Hourly Modeling for 11 PM and 12 AM
...
hour1 <- era_data[era_data$Hour == 23, ]
hour2 <- era_data[era_data$Hour == 0, ]
...
save(model1, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_11PM.Rdata")
save(model2, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_12AM.Rdata")
