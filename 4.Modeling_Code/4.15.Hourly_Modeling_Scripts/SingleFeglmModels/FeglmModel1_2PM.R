#ERA Hourly Modeling for 1 PM and 2 PM
...
hour1 <- era_data[era_data$Hour == 13, ]
hour2 <- era_data[era_data$Hour == 14, ]
...
save(model1, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_1PM.Rdata")
save(model2, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_2PM.Rdata")
