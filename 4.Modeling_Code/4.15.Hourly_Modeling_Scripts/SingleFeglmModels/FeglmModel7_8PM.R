#ERA Hourly Modeling for 7 PM and 8 PM
...
hour1 <- era_data[era_data$Hour == 19, ]
hour2 <- era_data[era_data$Hour == 20, ]
...
save(model1, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_7PM.Rdata")
save(model2, file = "/home/kfc27/project/ERAProcessingData/StepFiveSavedModels/FeglmModels/feglmModel_8PM.Rdata")
